...
class UpdateTagCategoryRequest extends FormRequest
{
    ...
    {
        $categoryId = $this->route('postCategory')->id ?? $this->route('post_category')->id;
        ...
        return [
            'name' => [
                ...
                'max:255',
                'regex:/^[\pL\pN\s\-_.,!?()]+$/u',
                Rule::unique('tags_category', 'name')->ignore($categoryId)
            ],
            'slug' => [
                'nullable',
                'string',
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('tags_category', 'slug')->ignore($categoryId)
            ],
            'description' => [
                'nullable',
                'string',

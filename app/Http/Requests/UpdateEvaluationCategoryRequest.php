...
class UpdateEvaluationCategoryRequest extends FormRequest
{
    ...
    {
        $categoryId = $this->route('question_category')->id;
        ...
        return [
            'name' => [
                ...
                'max:255',
                'regex:/^[\pL\pN\s\-_.,!?()]+$/u',
                Rule::unique('evaluation_categories', 'name')->ignore($categoryId)
            ],
            'slug' => [
                'nullable',
                'string',
                ...
                'max:255',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('evaluation_categories', 'slug')->ignore($categoryId)
            ],
            'description' => [
                'nullable',
                'string',

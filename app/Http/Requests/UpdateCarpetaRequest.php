...
class UpdateCarpetaRequest extends FormRequest
{
    ...
    {
        $carpetaId = $this->route('carpeta')->id;
        ...
        return [
            ...
            'padre_id' => [
                ...
                function ($attribute, $value, $fail) {
                    $carpetaActual = $this->route('carpeta');
                    
                    if ($value) {
                        // No puede ser padre de sí misma
                        if ($value == $carpetaActual->id) {
                            $fail('Una carpeta no puede ser padre de sí misma.');
                        }
                        
                        // Verificar que no sea un descendiente (evitar referencias circulares)
                        if ($carpetaActual->esDescendiente($value)) {
                            $fail('No se puede mover una carpeta a una de sus subcarpetas.');
                        }

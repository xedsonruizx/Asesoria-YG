                    ...
                    <DropdownMenu v-if="auth.user">
                        ...
                        <DropdownMenuContent align="end" class="w-56">
                            ...
                            <DropdownMenuItem as-child>
                                <Link href="/auth-settings" class="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
                            ...
                            <DropdownMenuItem v-if="canManage" as-child>
                                <Link href="/dashboard" class="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">

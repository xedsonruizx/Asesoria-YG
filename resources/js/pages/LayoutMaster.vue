...
<template>
    <Head title="Asesorías YG - Servicios Legales Profesionales">
        <link rel="preconnect" href="https://rsms.me/" />
        <link rel="stylesheet" href="https://rsms.me/inter/inter.css" />
        <meta name="description" content="Servicios de asesoría legal profesional. Consultoría jurídica especializada en derecho civil, comercial y laboral." />
    </Head>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-300">
                            <li><a href="#" class="hover:text-white transition-colors">Derecho Civil</a></li>
                            <li><a href="#" class="hover:text-white transition-colors">Derecho Comercial</a></li>
                            <li><a href="#" class="hover:text-white transition-colors">Derecho Laboral</a></li>
                            <li><a href="#" class="hover:text-white transition-colors">Consultoría Legal</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-gray-300">
                            <li><Link :href="publicaciones()" class="hover:text-white transition-colors">Publicaciones</Link></li>
                            <li><Link :href="register()" class="hover:text-white transition-colors">Contacto</Link></li>
